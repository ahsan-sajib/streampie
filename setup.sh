...
wget -O docker-compose.yml https://raw.githubusercontent.com/ahsan-sajib/streampie/main/docker/docker-compose.prod.yaml

while [ -z "${RTMPIE_HOSTNAME}" ]; do
  read -p "Enter the hostname you want to use for Streampie (e.g. demo.rtmpie.de): " -e RTMPIE_HOSTNAME
done
